...
246,712, the embed 448 — 972,980; the staged total reads 973,032, the rest
being rounding and the timers of the snapshot stage, empty in the app build
and still reading 56. A quarter of
...
through the sweep is `302 + 8s` cycles, `s` its shift (2 to 5 for this
