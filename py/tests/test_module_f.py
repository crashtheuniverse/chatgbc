...
def after_run():
    ...
    names = ["wDbgEmb", "wDbgAdd", "wDbgXb", "wDbgZl", "wDbgHt", "wDbgAtt",
             "wDbgAo", "wDbgRes", "wDbgXf", "wDbgExpert",
             "wDbgH1", "wDbgHb", "wDbgFfn"]
    sizes = {"wDbgAdd": _const("TEST_ADD_ROWS") * DIM, "wDbgExpert": 1,
...
def test_probes_assemble_into_the_lab_only():
    ...
    for name in ("wDbgAtt", "wDbgExpert", "wDbgFfn", "wDbgEmb", "wDbgAdd"):
...
def test_layer0_probes_are_the_twins_intermediates(q, after_run):
    ...
    assert after_run["wDbgExpert"][0] == e, (after_run["wDbgExpert"][0], e)
